"""Tests for arxivparser.convert — LaTeXML conversion."""
...
from arxivparser.convert import _find_latexml, tex_to_xml
from arxivparser.errors import ConversionError


class TestFindLatexml:
    @patch("arxivparser.convert.shutil.which")
...
class TestTexToXml:
    @patch("arxivparser.convert.subprocess.run")
    @patch("arxivparser.convert._find_latexml")
